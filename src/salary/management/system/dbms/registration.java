...
public class registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbuttonAddRecord.setBackground(new java.awt.Color(0, 153, 0));
        jbuttonAddRecord.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jbuttonAddRecord.setForeground(new java.awt.Color(255, 255, 255));
        jbuttonAddRecord.setText("Submit");
        jbuttonAddRecord.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbuttonAddRecordActionPerformed(evt);
            }
        });
        jPanel1.add(jbuttonAddRecord);
        jbuttonAddRecord.setBounds(890, 640, 150, 40);
    ...
    private void txt_idKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_idKeyReleased
        ...
        try{
          ...
          String s=txt_id.getText();
          
            String sql="SELECT* FROM `code` WHERE `code`='"+s+"'";
            ResultSet rs;
            rs=statment.executeQuery(sql);
            rs.next();
           
            String add10=rs.getString("division");
            ...
            String add18=rs.getString("designation");
    ...
    private void jbuttonAddRecordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbuttonAddRecordActionPerformed
        ...
        if(x==0){
            try{
                ...
                String query="INSERT INTO `staff information`(`First_Name`, `Surname`, `Date_Of_Birth`, `Email`, `Contact`, `Gender`, `Present_Address`, `Permanent_Address`, `Department`, `Salary`, `Apartment`, `Post_Code`, `Designation`, `Status`, `Date_Hired`, `Job_Title`) VALUES ('"+fname+"','"+sname+"','"+dob+"','"+email+"','"+contact+"','"+gender+"','"+paddress+"','"+peraddress+"','"+department+"','"+salary+"','"+house+"','"+post+"','"+designation+"','"+status+"','"+doh+"','"+title+"')";

                statment.executeUpdate(query);
               
               
                String add3=txt_birth.getText();
           
                String r=add3.replace("/","");
                int dob1=Integer.parseInt(r);
                
                int result=dob1+5;
                
                String add4=txt_depertment.getText();
                String sql2="SELECT * FROM `staff information` WHERE `Email`='"+email+"' ";
                  ResultSet rs;
                  rs=statment.executeQuery(sql2);
                  rs.next();
                  String id=rs.getString("id");
                String sql="INSERT INTO `users`(`username`, `password`, `division`,`employee_id`) VALUES ('"+email+"',"+result+",'"+add4+"','"+id+"')";
            ...
            {
                JOptionPane.showMessageDialog(null, "Email Account Alreday Exist");
            }
