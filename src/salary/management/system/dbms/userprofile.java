...
public class userprofile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_pass.setBounds(770, 620, 270, 40);
        ...
        jLabel19.setBounds(640, 630, 120, 21);
        ...
        jButton1.setBounds(220, 80, 150, 50);
        ...
        jButton_Delete.setBounds(930, 680, 105, 40);
        ...
        jButtonUpdate.setBounds(780, 680, 120, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql="SELECT * FROM `staff information` WHERE `id`="+id1+"";
            ResultSet rs;
            ...
            txt_title.setEditable(false);
             int id3=Emp.empId;
          String i5=String.valueOf(id3);
            String sql2="SELECT * FROM `users` WHERE `employee_id`='"+i5+"'";
            ResultSet rs1;
            rs1=statment.executeQuery(sql2);
            rs1.next();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
     ...
     if(x==0){
        try{
          ...
          int id1=Emp.empId;
          String i3=String.valueOf(id1);
          String pass=txt_pass.getText();
          String sql2="UPDATE `users` SET `password`='"+pass+"' WHERE `employee_id`='"+i3+"'";
